# Verify/Check Mode for `setup-tia-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-tia-skills`.
...
- #106: Feature request: verify/check mode for setup-tia-skills
