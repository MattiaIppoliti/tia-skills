...
| --- | --- |
| Your own head, unsharpened | [grill-me](https://github.com/MattiaIppoliti/tia-skills/blob/main/docs/productivity/grill-me.md) |
| The codebase | [grill-with-docs](https://github.com/MattiaIppoliti/tia-skills/blob/main/docs/engineering/grill-with-docs.md) |
| Someone else's head | `to-questionnaire` |
| Nobody's head yet, the question needs something to react to | [prototype](https://github.com/MattiaIppoliti/tia-skills/blob/main/docs/engineering/prototype.md) |
...
Its neighbour is [grill-me](https://github.com/MattiaIppoliti/tia-skills/blob/main/docs/productivity/grill-me.md), and the two split on where the answers live: grilling mines you, a questionnaire mines someone else. What comes back is raw material: feed it into another grilling round, or into [grill-with-docs](https://github.com/MattiaIppoliti/tia-skills/blob/main/docs/engineering/grill-with-docs.md) or [to-spec](https://github.com/MattiaIppoliti/tia-skills/blob/main/docs/engineering/to-spec.md) if the work is heading for a build. When you're unsure which skill fits the moment, [ask-mattia](https://github.com/MattiaIppoliti/tia-skills/blob/main/docs/engineering/ask-mattia.md) routes you.
