...
Vendored from [cursor/plugins](https://github.com/cursor/plugins/tree/main/pstack/skills/unslop). The rules are upstream's; only the frontmatter is rewritten to match this repo's model-invoked convention (see [`.agents/invocation.md`](../../../.agents/invocation.md)).
